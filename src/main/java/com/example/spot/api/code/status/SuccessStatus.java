...
public enum SuccessStatus implements BaseCode {
    ...
    //알림 관련 응답
    _NOTIFICATION_FOUND(HttpStatus.OK, "NOTIFICATION5001", "전체 알림 조회 완료"),
    _NOTIFICATION_READ(HttpStatus.OK, "NOTIFICATION5002", "알림 읽음 처리 완료"),
    _NOTIFICATINO_APPLIED_STUDY_FOUND(HttpStatus.OK, "NOTIFICATION5003", "참가 신청한 스터디 알림 조회 완료"),
    _NOTIFICATION_APPLIED_STUDY_JOINED(HttpStatus.OK, "NOTIFICATION5004", "참가 신청한 스터디 최종 참여 확인 완료"),
    _NOTIFICATION_APPLIED_STUDY_REJECTED(HttpStatus.OK, "NOTIFICATION5005", "참가 신청한 스터디 최종 참여 거절 완료"),
