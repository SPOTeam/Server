...
public interface NotificationCommandService {
    ...
    // 신청한 스터디 참가
    NotificationResponseDTO.NotificationDTO joinAppliedStudy(long studyId, Long memberId);
    // 신청한 스터디 거절
    NotificationResponseDTO.NotificationDTO rejectAppliedStudy(long studyId, Long memberId);
}
